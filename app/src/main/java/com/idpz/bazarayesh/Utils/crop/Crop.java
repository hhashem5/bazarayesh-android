package com.idpz.bazarayesh.Utils.crop;
...
public class Crop {
    ...
    private static void showImagePickerError(Context context) {
        Toast.makeText(context.getApplicationContext(), "مشکل برش عکس رخ داد", Toast.LENGTH_SHORT).show();
    }
    ...
    /**
     * Set whether to savePhrViews the result as a PNG or not. Helpful to preserve alpha.
     *
     * @param asPng whether to savePhrViews the result as a PNG or not
     */
